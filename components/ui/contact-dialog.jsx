        ...
        <DialogContent className="sm:max-w-[1055px] w-full bg-white">
          ...
          >
            <div className="sm:col-span-2">
              ...
              <div className="mt-1">
                <input
                  ...
                  id="name"
                  autoComplete="name"
                  className="block w-full focus:outline-none shadow-sm focus:ring-2 sm:text-sm focus:ring-green-700 bg-neutral-100 rounded-md h-12 p-4"
                />
              </div>
            </div>
            <div className="sm:col-span-2">
            ...
            <div className="sm:col-span-2">
              ...
              <div className="mt-1">
                <textarea
                  id="message"
                  rows={4}
                  className="block max-h-36 w-full focus:outline-none shadow-sm focus:ring-2 sm:text-sm focus:ring-green-700 bg-neutral-100 rounded-md p-4"
                  defaultValue={""}
                />
              </div>
            </div>
            <div className="sm:col-span-2 sm:flex sm:justify-end">
              <button
                type="submit"
                className="w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-green-900 hover:bg-green-900/80 focus:outline-none focus:ring-2  transition-all focus:ring-offset-2 focus:ring-green-950"
              >
                Send
              </button>
            </div>
